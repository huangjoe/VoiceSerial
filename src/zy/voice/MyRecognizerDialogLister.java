...
public class MyRecognizerDialogLister implements RecognizerDialogListener,
     ...
     * 缓冲进度 0-100 beginPos 缓冲音频在文中的开始位置 endPos 缓冲音频在文中的末位置 info 附加信息
     */
    ...
    /**
     * percent 播放进度 0-100 beginPos 播放音频在文中的开始位置 endPos 播放音频在文中的末位置
     * */
    @Override
